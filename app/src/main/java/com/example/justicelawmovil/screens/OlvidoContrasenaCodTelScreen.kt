...
@Composable
fun OlvidoContrasenaCodTel(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Text(
            text = "Ingresa el código de confirmación que se envió a tu mumero telefonico para restablecer la contraseña",
            fontSize = 14.sp,
            color = Color(0xFF001C36)
        )
